...
async def start_cmd(bot, msg):
    ...
    btn = InlineKeyboardMarkup([[
        InlineKeyboardButton("🤖 SOURCE CODE", url="https://github.com/Aluval/Renamebot24-")
        ],[
        InlineKeyboardButton("🖥️ How To Deploy", url="SUNRISES")
    ]])
...
async def start(bot, msg, cb=True):   
    txt=f"Hello! @sunriseseditsoffical6 {msg.from_user.mention} i am simple rename bot with personal usage.\nthis bot is made by <b><a href=https://github.com/Aluval/Renamebot24->sunriseseditsoffical6</a></b>"                                     
    button= [[
